...
def xywh2xyxy(x): # yolov7/utils/general.py
...
def xyxy2xywh(x): # yolov7/utils/general.py
...
class BYTETracker(object):
    def __init__(self, frame_rate=30,track_thresh=0.8,track_buffer=25,match_thresh=0.5):
